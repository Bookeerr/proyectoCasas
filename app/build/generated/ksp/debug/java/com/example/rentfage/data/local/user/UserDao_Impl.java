...
public final class UserDao_Impl implements UserDao {
  ...
  public UserDao_Impl(@NonNull final RoomDatabase __db) {
    ...
    this.__insertionAdapterOfUserEntity = new EntityInsertionAdapter<UserEntity>(__db) {
      ...
      protected String createQuery() {
        return "INSERT OR ABORT INTO `users` (`id`,`name`,`email`,`phone`,`pass`) VALUES (nullif(?, 0),?,?,?,?)";
      }
  ...
  @Override
  public Object insertar(final UserEntity user, final Continuation<? super Long> $completion) {
      ...
      public UserEntity call() throws Exception {
        ...
        try {
          ...
          if (_cursor.moveToFirst()) {
            ...
            _result = new UserEntity(_tmpId,_tmpName,_tmpEmail,_tmpPhone,_tmpPass);
          } else {
            _result = null;
          }
          return _result;
      ...
      public List<UserEntity> call() throws Exception {
        ...
        try {
          ...
          while (_cursor.moveToNext()) {
            ...
            final String _tmpPass;
            _tmpPass = _cursor.getString(_cursorIndexOfPass);
            _item = new UserEntity(_tmpId,_tmpName,_tmpEmail,_tmpPhone,_tmpPass);
            _result.add(_item);
          }
          return _result;
        } finally {
